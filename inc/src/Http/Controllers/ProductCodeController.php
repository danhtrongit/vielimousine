...
use Vie\Container;
use Vie\Repository\ProductCodeRepository;
use Vie\Support\ResponseEnvelope;
use Vie\Support\Validator;
use Vie\Validation\Schemas\ProductCodeValidation;

final class ProductCodeController
{
    public static function index(\WP_REST_Request $request): \WP_REST_Response
    {
        $repo   = Container::get(ProductCodeRepository::class);
    ...
    public static function show(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        if ($row === null) {
            return ResponseEnvelope::notFound('Product Code');
        }
    ...
    public static function store(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        $v    = Validator::validate($data, ProductCodeValidation::createRules());
    ...
    public static function update(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        $data = $request->get_json_params();
        $v    = Validator::validate($data, ProductCodeValidation::updateRules($id));
