...
use Vie\Validation\Schemas\CustomerValidation;
...
final class CustomerController
{
    ...
    public static function store(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        $v    = Validator::validate($data, CustomerValidation::createRules());
    ...
    public static function update(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        $data = $request->get_json_params();
        $v    = Validator::validate($data, CustomerValidation::updateRules($id));
