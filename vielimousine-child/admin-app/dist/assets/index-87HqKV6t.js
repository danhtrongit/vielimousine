import{B as k,K as C,o as b,c as p,a as K,p as u,a6 as M,G as s,k as _,t as N,ap as F,aB as x,ay as j,ax as z,v as V,av as W,a2 as H,a4 as Q,aR as G,aQ as X,F as B,s as Y,y as Z,f as S,w as q,g as $,A as O,E as J}from"./index-CL3n1zny.js";import{s as I}from"./index-Cdbmqg_V.js";function g(...t){if(t){let n=[];for(let o=0;o<t.length;o++){let r=t[o];if(!r)continue;let e=typeof r;if(e==="string"||e==="number")n.push(r);else if(e==="object"){let d=Array.isArray(r)?[g(...r)]:Object.entries(r).map(([l,c])=>c?l:void 0);n=d.length?n.concat(d.filter(l=>!!l)):n}}return n.join(" ").trim()}}var tt=`
.p-icon {
