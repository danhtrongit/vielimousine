    ...
    },
    {
      ...
      children: [
        ...
        { path: 'orders/:id',
          ...
          meta: { capAny: ['vie_view_own_orders', 'vie_view_all_orders'] } },
        { path: 'booking-quotes',
          component: () => import('@/views/booking-quotes/BookingQuoteListView.vue'),
          meta: { capAny: ['vie_view_own_booking_quotes', 'vie_view_all_booking_quotes'] } },
        { path: 'booking-quotes/new', name: 'booking-quotes-new',
          component: () => import('@/views/booking-quotes/BookingQuoteDetailView.vue'),
          meta: { cap: 'vie_create_booking_quotes' } },
        { path: 'booking-quotes/:id', name: 'booking-quotes-detail',
          component: () => import('@/views/booking-quotes/BookingQuoteDetailView.vue'),
          meta: { capAny: ['vie_view_own_booking_quotes', 'vie_view_all_booking_quotes'] } },
        { path: 'customers',
        ...
        { path: 'coupons/bulk',
          component: () => import('@/views/coupons/CouponBulkView.vue'),
          meta: { cap: 'vie_manage_coupons' } },
        { path: 'coupons/:id',
