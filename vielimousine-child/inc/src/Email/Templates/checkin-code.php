...
?>
<h2 style="margin:0 0 12px;color:#007A3D;font-size:18px;">Mã nhận phòng của bạn</h2>
...
<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:18px 0;">
  <tr>
    <td align="center" style="background:#ecfdf5;border:1px dashed #10b981;border-radius:8px;padding:18px 24px;">
      <div style="font-size:12px;color:#007A3D;letter-spacing:0.5px;text-transform:uppercase;margin-bottom:6px;">Mã nhận phòng</div>
      <div style="font-size:24px;font-weight:700;color:#007A3D;letter-spacing:2px;font-family:Consolas,Menlo,monospace;">
