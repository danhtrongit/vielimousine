...
<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:separate;border:1px solid #e5e7eb;border-radius:6px;margin:0 0 12px;">
  ...
  <tr><td style="padding:6px 12px;color:#6b7280;">Hoàn lại khách</td><td style="padding:6px 12px;font-weight:600;color:#007A3D;"><?php echo esc_html((string) ($ctx['refund_amount'] ?? '')); ?></td></tr>
