...
final class CouponUsageSchema
{
    ...
    public static function install(\wpdb $wpdb): void
    {
        ...
        //
        // user_phone: danh tính chính của khách (email là tùy chọn ở form đặt phòng).
        // Giới hạn "N lượt/khách" đếm theo SĐT HOẶC email — xem
        // CouponUsageRepository::countForIdentity().
