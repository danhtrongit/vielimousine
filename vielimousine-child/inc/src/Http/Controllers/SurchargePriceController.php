...
use Vie\Validation\Schemas\SurchargePriceValidation;

final class SurchargePriceController
{
    public static function index(\WP_REST_Request $request): \WP_REST_Response
    {
        $repo   = Container::get(SurchargePriceRepository::class);
    ...
    public static function show(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        if ($row === null) {
            return ResponseEnvelope::notFound('Surcharge Price');
        }
    ...
    public static function store(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        $v    = Validator::validate($data, SurchargePriceValidation::createRules());
    ...
    public static function update(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        $data = $request->get_json_params();
        $v    = Validator::validate($data, SurchargePriceValidation::updateRules($id));
