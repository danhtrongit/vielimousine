...
\defined( 'ABSPATH' ) || die;
use HD\Helper;
$title_partner = Helper::getField( 'title_partner' );
$gallery = Helper::getField( 'gallery_partner' );
?>
<section class="section route-partner home-partner section-padding relative">
