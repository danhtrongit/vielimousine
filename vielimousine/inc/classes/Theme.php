...
final class Theme {
	...
	private function init(): void {
		...
		// Remove unused Google Fonts at late priority (after all plugins)
	...
	public function wp_enqueue_scripts(): void {
		...
		wp_enqueue_style( 'swiper-css', ASSETS_URL . 'css/swiper-css.css', [ 'vendor-css' ], $version );
		wp_enqueue_style( 'slick-css', ASSETS_URL . 'css/slick.css', [], $version );
		...
		wp_enqueue_script( 'swiper-js', ASSETS_URL . 'js/swiper.js', [ 'jquery-core' ], $version, true );
		wp_script_add_data( 'swiper-js', 'extra', [ 'module', 'defer' ] );

		// Only load jquery-ui on pages that actually need it (e.g., booking/checkout with datepicker)
		if ( is_page( 'dat-phong' ) || is_singular( 'hotel' ) ) {
			wp_enqueue_script( 'jquery-ui-js', ASSETS_URL . 'js/jquery-ui.min.js', [ 'jquery-core' ], $version, true );
			wp_script_add_data( 'jquery-ui-js', 'extra', [ 'module', 'defer' ] );
		}

		// wp_enqueue_script( 'woocommerce-js', ASSETS_URL . 'js/woocommerce.js', [ 'jquery-core' ], $version, true );
		// wp_script_add_data( 'woocommerce-js', 'extra', [ 'module', 'defer' ] );


		wp_add_inline_script( 'jquery-core', 'Object.assign(window, { $: jQuery, jQuery });', 'after' );

		/** Homepage */
		if ( Helper::isPageTemplate( 'templates/page-home.php' ) ) {
		...
		/** Homepage */
		if ( Helper::isPageTemplate( 'templates/page-about-us.php' ) ) {
			wp_enqueue_style( 'about-css', ASSETS_URL . 'css/about-css.css', [], $version );
			wp_enqueue_script( 'about-js', ASSETS_URL . 'js/about.js', [ 'jquery-core' ], $version, true );
			wp_script_add_data( 'about-js', 'extra', [ 'module', 'defer' ] );
		}

		/** Page Tuyen xe */
		if ( Helper::isPageTemplate( 'templates/page-route-limo.php' ) ) {
			wp_enqueue_style( 'route-css', ASSETS_URL . 'css/route-css.css', [], $version );
			
			// slick
			// wp_enqueue_script( 'slick-js', ASSETS_URL . 'js/slick.min.js', [ 'jquery-core' ], $version, true );
			// wp_script_add_data( 'slick-js', 'extra', [ 'module', 'defer' ] );
			// js
			wp_enqueue_script( 'route-js', ASSETS_URL . 'js/route.js', [ 'jquery-core' ], $version, true );
			wp_script_add_data( 'route-js', 'extra', [ 'module', 'defer' ] );
		}

		/** Page Thue xe */
		if ( Helper::isPageTemplate( 'templates/page-car-rental.php' ) ) {
			wp_enqueue_style( 'car-rental', ASSETS_URL . 'css/car-rental.css', [], $version );
			
			wp_enqueue_script( 'rental-js', ASSETS_URL . 'js/rental.js', [ 'jquery-core' ], $version, true );
			wp_script_add_data( 'rental-js', 'extra', [ 'module', 'defer' ] );
			// slick
			// wp_enqueue_script( 'slick-js', ASSETS_URL . 'js/slick.min.js', [ 'jquery-core' ], $version, true );
			// wp_script_add_data( 'slick-js', 'extra', [ 'module', 'defer' ] );
			// 
		...
		/** Page Hotel */
		if ( Helper::isPageTemplate( 'templates/page-hotel.php' ) ) {
			wp_enqueue_style( 'hotel-css', ASSETS_URL . 'css/hotel-css.css', [], $version );

			wp_enqueue_script( 'rental-js', ASSETS_URL . 'js/rental.js', [ 'jquery-core' ], $version, true );
			wp_script_add_data( 'rental-js', 'extra', [ 'module', 'defer' ] );
			
			// wp_enqueue_script( 'hotel-js', ASSETS_URL . 'js/hotel.js', [ 'jquery-core' ], $version, true );
			// wp_script_add_data( 'hotel-js', 'extra', [ 'module', 'defer' ] );
			// slick
			// wp_enqueue_script( 'slick-js', ASSETS_URL . 'js/slick.min.js', [ 'jquery-core' ], $version, true );
			// wp_script_add_data( 'slick-js', 'extra', [ 'module', 'defer' ] );
			// 
		...
		/** Single Posts */
		if ( is_singular('post') ) {
			wp_enqueue_style( 'single-post', ASSETS_URL . 'css/single-post.css', [], $version );
		}
		/** Single Hotel */
		if ( is_singular('hotel') ) {
			wp_enqueue_style( 'single-hotel', ASSETS_URL . 'css/single-hotel.css', [], $version );

			wp_enqueue_script( 'hotel-js', ASSETS_URL . 'js/hotel.js', [ 'jquery-core' ], $version, true );
			wp_script_add_data( 'hotel-js', 'extra', [ 'module', 'defer' ] );
		}
		/** Archive, Taxonomy Hotel */
		if ( is_post_type_archive('hotel') || is_tax('hotel-category') || is_tax('hotel-location') ) {
			wp_enqueue_style( 'taxonomy-hotel', ASSETS_URL . 'css/taxonomy-hotel.css', [], $version );
		}

		// Page Tour
		if ( Helper::isPageTemplate( 'templates/page-tour.php' ) || is_tax('tour-category') || is_tax('tour-location') || is_tax('tour-duration') ) {
			wp_enqueue_style( 'tour-css', ASSETS_URL . 'css/tour.css', [], $version );
			
		}

		/** Single Tour */
		if ( is_singular('tour') ) {
			wp_enqueue_style( 'single-tour', ASSETS_URL . 'css/single-tour.css', [], $version );
		}
