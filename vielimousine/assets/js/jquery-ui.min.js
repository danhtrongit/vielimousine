...
!(function(t) {
  ...
  V.cleanData = (n = V.cleanData, function(t2) {
    ...
    return e2 || (e2 = i2, i2 = V.Widget), Array.isArray(e2) && (e2 = V.extend.apply(null, [{}].concat(e2))), V.expr.pseudos[l2.toLowerCase()] = function(t3) {
      ...
      if (!this._createWidget) return new n2(t3, e3);
    ...
    for (var e2, i2, s2 = r.call(arguments, 1), n2 = 0, o2 = s2.length; n2 < o2; n2++) for (e2 in s2[n2]) i2 = s2[n2][e2], a.call(s2[n2], e2) && void 0 !== i2 && (V.isPlainObject(i2) ? t2[e2] = V.isPlainObject(t2[e2]) ? V.widget.extend({}, t2[e2], i2) : V.widget.extend({}, i2) : t2[e2] = i2);
    return t2;
    ...
    var o2 = [], a2 = this;
    function t2(t3, e2) {
      for (var i2, s2 = 0; s2 < t3.length; s2++) i2 = a2.classesElementLookup[t3[s2]] || V(), i2 = n2.add ? (n2.element.each(function(t4, e3) {
        V.map(a2.classesElementLookup, function(t5) {
          return t5;
        }).some(function(t5) {
          return t5.is(e3);
        }) || a2._on(V(e3), { remove: "_untrackClassesElement" });
  ...
  x = Math.max, k = Math.abs, o = /left|center|right/, l = /top|center|bottom/, h = /[\+\-]\d+(\.[\d]+)?%?/, c = /^\w+/, u = /%$/, C = V.fn.position, V.position = { scrollbarWidth: function() {
    ...
    if (!u2 || !u2.of) return C.apply(this, arguments);
  ...
  V.expr.pseudos || (V.expr.pseudos = V.expr[":"]), V.uniqueSort || (V.uniqueSort = V.unique), V.escapeSelector || (e = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, d = function(t2, e2) {
    return e2 ? "\0" === t2 ? "�" : t2.slice(0, -1) + "\\" + t2.charCodeAt(t2.length - 1).toString(16) + " " : "\\" + t2;
  }, V.escapeSelector = function(t2) {
    return (t2 + "").replace(e, d);
  ...
  } }), V.fn.extend({ uniqueId: (p = 0, function() {
  ...
  V.widget("ui.mouse", { version: "1.13.0", options: { cancel: "input, textarea, button, select, option", distance: 1, delay: 0 }, _mouseInit: function() {
    var e2 = this;
    ...
    if (!f) {
      ...
      }, this.document.on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate), t2.preventDefault(), f = true)) : true;
    }
  ...
  V.widget("ui.draggable", V.ui.mouse, { version: "1.13.0", widgetEventPrefix: "drag", options: { addClasses: true, appendTo: "parent", axis: false, connectToSortable: false, containment: false, cursor: "auto", cursorAt: false, grid: false, handle: false, helper: "original", iframeFix: false, opacity: false, refreshPositions: false, revert: false, revertDuration: 500, scope: "default", scroll: true, scrollSensitivity: 20, scrollSpeed: 20, snap: false, snapMode: "both", snapTolerance: 20, stack: false, zIndex: false, drag: null, start: null, stop: null }, _create: function() {
  ...
  V.widget("ui.droppable", { version: "1.13.0", widgetEventPrefix: "drop", options: { accept: "*", addClasses: true, greedy: false, scope: "default", tolerance: "intersect", activate: null, deactivate: null, drop: null, out: null, over: null }, _create: function() {
    ...
    switch (i2) {
      ...
      case "pointer":
        return g(s2.pageY, h2, e2.proportions().height) && g(s2.pageX, l2, e2.proportions().width);
      case "touch":
  ...
  V.ui.droppable;
  V.widget("ui.resizable", V.ui.mouse, { version: "1.13.0", widgetEventPrefix: "resize", options: { alsoResize: false, animate: false, animateDuration: "slow", animateEasing: "swing", aspectRatio: false, autoHide: false, classes: { "ui-resizable-se": "ui-icon ui-icon-gripsmall-diagonal-se" }, containment: false, ghost: false, grid: false, handles: "e,s,se", helper: false, maxHeight: null, maxWidth: null, minHeight: 10, minWidth: 10, zIndex: 90, resize: null, start: null, stop: null }, _num: function(t2) {
  ...
  V.ui.resizable, V.widget("ui.selectable", V.ui.mouse, { version: "1.13.0", options: { appendTo: "body", autoRefresh: true, distance: 0, filter: "*", tolerance: "touch", selected: null, selecting: null, start: null, stop: null, unselected: null, unselecting: null }, _create: function() {
    var i2 = this;
  ...
  } }), V.widget("ui.sortable", V.ui.mouse, { version: "1.13.0", widgetEventPrefix: "sort", ready: false, options: { appendTo: "parent", axis: false, connectWith: false, containment: false, cursor: "auto", cursorAt: false, dropOnEmpty: true, forcePlaceholderSize: false, forceHelperSize: false, grid: false, handle: false, helper: "original", items: "> *", opacity: false, placeholder: false, revert: false, scroll: true, scrollSensitivity: 20, scrollSpeed: 20, scope: "default", tolerance: "intersect", zIndex: 1e3, activate: null, beforeStop: null, change: null, deactivate: null, out: null, over: null, receive: null, remove: null, sort: null, start: null, stop: null, update: null }, _isOverAxis: function(t2, e2, i2) {
    return e2 <= t2 && t2 < e2 + i2;
    ...
    return V.ui.ddmanager && V.ui.ddmanager.drag(this, t2), this._trigger("sort", t2, this._uiHash()), this.lastPositionAbs = this.positionAbs, false;
    ...
    var e2, i2;
    if (this.floating = !!this.items.length && ("x" === this.options.axis || this._isFloating(this.items[0].item)), null !== this.innermostContainer && this._refreshItemPositions(t2), this.options.custom && this.options.custom.refreshContainers) this.options.custom.refreshContainers.call(this);
    ...
    if (this.innermostContainer = c2) if (1 === this.containers.length) this.containers[u2].containerCache.over || (this.containers[u2]._trigger("over", t2, this._uiHash(this)), this.containers[u2].containerCache.over = 1);
    else {
  ...
  } }), V.widget("ui.accordion", { version: "1.13.0", options: { active: 0, animate: {}, classes: { "ui-accordion-header": "ui-corner-top", "ui-accordion-header-collapsed": "ui-corner-all", "ui-accordion-content": "ui-corner-bottom" }, collapsible: false, event: "click", header: function(t2) {
  ...
  } }), V.widget("ui.menu", { version: "1.13.0", defaultElement: "<ul>", delay: 300, options: { icons: { submenu: "ui-icon-caret-1-e" }, items: "> *", menus: "ul", position: { my: "left top", at: "right top" }, role: "menu", blur: null, focus: null, select: null }, _create: function() {
  ...
  V.widget("ui.autocomplete", { version: "1.13.0", defaultElement: "<input>", options: { appendTo: null, autoFocus: false, delay: 300, minLength: 1, position: { my: "left top", at: "left bottom", collision: "none" }, source: null, change: null, close: null, focus: null, open: null, response: null, search: null, select: null }, requestIndex: 0, pending: 0, _create: function() {
    ...
    this.isMultiLine = e2 || !t2 && this._isContentEditable(this.element), this.valueMethod = this.element[e2 || t2 ? "val" : "text"], this.isNewMenu = true, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "off"), this._on(this.element, { keydown: function(t3) {
      ...
      if (i2) return i2 = false, void (this.isMultiLine && !this.menu.element.is(":visible") || t3.preventDefault());
      if (!s2) {
        var e3 = V.ui.keyCode;
        switch (t3.keyCode) {
          case e3.PAGE_UP:
      ...
      if (n2) return n2 = false, void t3.preventDefault();
      ...
      var i3;
      if (this.isNewMenu && (this.isNewMenu = false, t3.originalEvent && /^mouse/.test(t3.originalEvent.type))) return this.menu.blur(), void this.document.one("mousemove", function() {
        V(t3.target).trigger(t3.originalEvent);
      });
      i3 = e3.item.data("ui-autocomplete-item"), false !== this._trigger("focus", t3, { item: i3 }) && t3.originalEvent && /^key/.test(t3.originalEvent.type) && this._value(i3.value), (i3 = e3.item.attr("aria-label") || i3.value) && String.prototype.trim.call(i3).length && (this.liveRegion.children().hide(), V("<div>").text(i3).appendTo(this.liveRegion));
    ...
    if (this.menu.element.is(":visible")) return this.menu.isFirstItem() && /^previous/.test(t2) || this.menu.isLastItem() && /^next/.test(t2) ? (this.isMultiLine || this._value(this.term), void this.menu.blur()) : void this.menu[t2](e2);
    this.search(null, e2);
  }, widget: function() {
    ...
    this._superApply(arguments), this.options.disabled || this.cancelSearch || (t2 = t2 && t2.length ? this.options.messages.results(t2.length) : this.options.messages.noResults, this.liveRegion.children().hide(), V("<div>").text(t2).appendTo(this.liveRegion));
  } });
  V.ui.autocomplete;
  ...
  V.widget("ui.controlgroup", { version: "1.13.0", defaultElement: "<div>", options: { direction: "horizontal", disabled: null, onlyVisible: true, items: { button: "input[type=button], input[type=submit], input[type=reset], button, a", controlgroupLabel: ".ui-controlgroup-label", checkboxradio: "input[type='checkbox'], input[type='radio']", selectmenu: "select", spinner: ".ui-spinner-input" } }, _create: function() {
    ...
    V.each(this.options.items, function(s2, t2) {
      var e2, n2 = {};
      if (t2) return "controlgroupLabel" === s2 ? ((e2 = o2.element.find(t2)).each(function() {
        var t3 = V(this);
    ...
    return V.each(i2, function(t2) {
      var e2 = s2.options.classes[t2] || "", e2 = String.prototype.trim.call(e2.replace(m, ""));
  ...
  V.widget("ui.checkboxradio", [V.ui.formResetMixin, { version: "1.13.0", options: { disabled: null, label: null, icon: true, classes: { "ui-checkboxradio-label": "ui-corner-all", "ui-checkboxradio-icon": "ui-corner-all" } }, _getCreateOptions: function() {
    var t2, e2 = this, i2 = this._super() || {};
    return this._readType(), t2 = this.element.labels(), this.label = V(t2[t2.length - 1]), this.label.length || V.error("No label found for checkboxradio widget"), this.originalLabel = "", this.label.contents().not(this.element[0]).each(function() {
      e2.originalLabel += 3 === this.nodeType ? V(this).text() : this.outerHTML;
    }), this.originalLabel && (i2.label = this.originalLabel), null != (t2 = this.element[0].disabled) && (i2.disabled = t2), i2;
  }, _create: function() {
    ...
    if ("label" !== t2 || e2) {
      if (this._super(t2, e2), "disabled" === t2) return this._toggleClass(this.label, null, "ui-state-disabled", e2), void (this.element[0].disabled = e2);
      this.refresh();
    }
  ...
  var _;
  V.ui.checkboxradio;
  V.widget("ui.button", { version: "1.13.0", defaultElement: "<button>", options: { classes: { "ui-button": "ui-corner-all" }, disabled: null, icon: null, iconPosition: "beginning", label: null, showLabel: true }, _getCreateOptions: function() {
  ...
  } }), V.fn.button = (_ = V.fn.button, function(i2) {
    ...
    return t2 ? this.length || "instance" !== i2 ? this.each(function() {
      ...
      t3 ? (t3.option(i2 || {}), t3._init && t3._init()) : "button" != e2 ? V(this).checkboxradio(V.extend({ icon: false }, i2)) : _.call(V(this), i2);
    })), n2;
  ...
  V.extend(V.ui, { datepicker: { version: "1.13.0" } }), V.extend(b.prototype, { markerClassName: "hasDatepicker", maxRows: 4, _widgetDatepicker: function() {
    return this.dpDiv;
    ...
    return { id: t2[0].id.replace(/([^A-Za-z0-9_\-])/g, "\\\\$1"), input: t2, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0, inline: e2, dpDiv: e2 ? y(V("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv };
    ...
    if (V.datepicker._get(i2, "constrainInput")) return e2 = V.datepicker._possibleChars(V.datepicker._get(i2, "dateFormat")), i2 = String.fromCharCode(null == t2.charCode ? t2.keyCode : t2.charCode), t2.ctrlKey || t2.metaKey || i2 < " " || !e2 || -1 < e2.indexOf(i2);
    ...
    var e2, i2, s2, n2;
    "input" !== (t2 = t2.target || t2).nodeName.toLowerCase() && (t2 = V("input", t2.parentNode)[0]), V.datepicker._isDisabledDatepicker(t2) || V.datepicker._lastInput === t2 || (n2 = V.datepicker._getInst(t2), V.datepicker._curInst && V.datepicker._curInst !== n2 && (V.datepicker._curInst.dpDiv.stop(true, true), n2 && V.datepicker._datepickerShowing && V.datepicker._hideDatepicker(V.datepicker._curInst.input[0])), false !== (i2 = (s2 = V.datepicker._get(n2, "beforeShow")) ? s2.apply(t2, [t2, n2]) : {}) && (P(n2.settings, i2), n2.lastVal = null, V.datepicker._lastInput = t2, V.datepicker._setDateFromField(n2), V.datepicker._inDialog && (t2.value = ""), V.datepicker._pos || (V.datepicker._pos = V.datepicker._findPos(t2), V.datepicker._pos[1] += t2.offsetHeight), e2 = false, V(t2).parents().each(function() {
      ...
      for (var e3, i3; t3.length && t3[0] !== document; ) {
        if (("absolute" === (e3 = t3.css("position")) || "relative" === e3 || "fixed" === e3) && (i3 = parseInt(t3.css("zIndex"), 10), !isNaN(i3) && 0 !== i3)) return i3;
        t3 = t3.parent();
      }
      return 0;
    ...
    this.maxRows = 4, (v = t2).dpDiv.empty().append(this._generateHTML(t2)), this._attachHandlers(t2);
    ...
    0 < n2.length && w.apply(n2.get(0)), t2.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), 1 < s2 && t2.dpDiv.addClass("ui-datepicker-multi-" + s2).css("width", 17 * s2 + "em"), t2.dpDiv[(1 !== i2[0] || 1 !== i2[1] ? "add" : "remove") + "Class"]("ui-datepicker-multi"), t2.dpDiv[(this._get(t2, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), t2 === V.datepicker._curInst && V.datepicker._datepickerShowing && V.datepicker._shouldFocusInput(t2) && t2.input.trigger("focus"), t2.yearshtml && (e2 = t2.yearshtml, setTimeout(function() {
    ...
    for (var i2, s2, o2, a2 = 0, r2 = (t2 ? t2.shortYearCutoff : null) || this._defaults.shortYearCutoff, r2 = "string" != typeof r2 ? r2 : (/* @__PURE__ */ new Date()).getFullYear() % 100 + parseInt(r2, 10), l2 = (t2 ? t2.dayNamesShort : null) || this._defaults.dayNamesShort, h2 = (t2 ? t2.dayNames : null) || this._defaults.dayNames, c2 = (t2 ? t2.monthNamesShort : null) || this._defaults.monthNamesShort, u2 = (t2 ? t2.monthNames : null) || this._defaults.monthNames, d2 = -1, p2 = -1, f2 = -1, g2 = -1, m2 = false, _2 = function(t3) {
      ...
      if (!e3) throw "Missing number at position " + a2;
      ...
      if (V.each(e3, function(t4, e4) {
        var i4 = e4[1];
        if (n2.substr(a2, i4.length).toLowerCase() === i4.toLowerCase()) return s3 = e4[0], a2 += i4.length, false;
      }), -1 !== s3) return s3 + 1;
      throw "Unknown name at position " + a2;
    }, y2 = function() {
      if (n2.charAt(a2) !== e2.charAt(w2)) throw "Unexpected literal at position " + a2;
      a2++;
    }, w2 = 0; w2 < e2.length; w2++) if (m2) "'" !== e2.charAt(w2) || _2("'") ? y2() : m2 = false;
    else switch (e2.charAt(w2)) {
      case "d":
        f2 = v2("d");
        break;
      case "D":
    ...
    if (a2 < n2.length && (s2 = n2.substr(a2), !/^\s+/.test(s2))) throw "Extra/unparsed characters found in date: " + s2;
    if (-1 === d2 ? d2 = (/* @__PURE__ */ new Date()).getFullYear() : d2 < 100 && (d2 += (/* @__PURE__ */ new Date()).getFullYear() - (/* @__PURE__ */ new Date()).getFullYear() % 100 + (d2 <= r2 ? 0 : -100)), -1 < g2) for (p2 = 1, f2 = g2; ; ) {
      if (f2 <= (i2 = this._getDaysInMonth(d2, p2 - 1))) break;
      p2++, f2 -= i2;
    }
    if ((o2 = this._daylightSavingAdjust(new Date(d2, p2 - 1, f2))).getFullYear() !== d2 || o2.getMonth() + 1 !== p2 || o2.getDate() !== f2) throw "Invalid date";
    return o2;
    ...
    if (K2 < 0 && (K2 += 12, U2--), q2) for (e2 = this._daylightSavingAdjust(new Date(q2.getFullYear(), q2.getMonth() - L2[0] * L2[1] + 1, q2.getDate())), e2 = j2 && e2 < j2 ? j2 : e2; this._daylightSavingAdjust(new Date(U2, K2, 1)) > e2; ) --K2 < 0 && (K2 = 11, U2--);
    for (t2.drawMonth = K2, t2.drawYear = U2, R2 = this._get(t2, "prevText"), R2 = F2 ? this.formatDate(R2, this._daylightSavingAdjust(new Date(U2, K2 - A2, 1)), this._getFormatConfig(t2)) : R2, i2 = this._canAdjustMonth(t2, -1, U2, K2) ? V("<a>").attr({ class: "ui-datepicker-prev ui-corner-all", "data-handler": "prev", "data-event": "click", title: R2 }).append(V("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (N2 ? "e" : "w")).text(R2))[0].outerHTML : W2 ? "" : V("<a>").attr({ class: "ui-datepicker-prev ui-corner-all ui-state-disabled", title: R2 }).append(V("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (N2 ? "e" : "w")).text(R2))[0].outerHTML, R2 = this._get(t2, "nextText"), R2 = F2 ? this.formatDate(R2, this._daylightSavingAdjust(new Date(U2, K2 + A2, 1)), this._getFormatConfig(t2)) : R2, s2 = this._canAdjustMonth(t2, 1, U2, K2) ? V("<a>").attr({ class: "ui-datepicker-next ui-corner-all", "data-handler": "next", "data-event": "click", title: R2 }).append(V("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (N2 ? "w" : "e")).text(R2))[0].outerHTML : W2 ? "" : V("<a>").attr({ class: "ui-datepicker-next ui-corner-all ui-state-disabled", title: R2 }).append(V("<span>").attr("class", "ui-icon ui-icon-circle-triangle-" + (N2 ? "w" : "e")).text(R2))[0].outerHTML, A2 = this._get(t2, "currentText"), W2 = this._get(t2, "gotoCurrent") && t2.currentDay ? B2 : O2, A2 = F2 ? this.formatDate(A2, W2, this._getFormatConfig(t2)) : A2, R2 = "", t2.inline || (R2 = V("<button>").attr({ type: "button", class: "ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all", "data-handler": "hide", "data-event": "click" }).text(this._get(t2, "closeText"))[0].outerHTML), F2 = "", E2 && (F2 = V("<div class='ui-datepicker-buttonpane ui-widget-content'>").append(N2 ? R2 : "").append(this._isInRange(t2, W2) ? V("<button>").attr({ type: "button", class: "ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all", "data-handler": "today", "data-event": "click" }).text(A2) : "").append(N2 ? "" : R2)[0].outerHTML), n2 = parseInt(this._get(t2, "firstDay"), 10), n2 = isNaN(n2) ? 0 : n2, o2 = this._get(t2, "showWeek"), a2 = this._get(t2, "dayNames"), r2 = this._get(t2, "dayNamesMin"), l2 = this._get(t2, "monthNames"), h2 = this._get(t2, "monthNamesShort"), c2 = this._get(t2, "beforeShowDay"), u2 = this._get(t2, "showOtherMonths"), d2 = this._get(t2, "selectOtherMonths"), p2 = this._getDefaultDate(t2), f2 = "", m2 = 0; m2 < L2[0]; m2++) {
      for (_2 = "", this.maxRows = 4, v2 = 0; v2 < L2[1]; v2++) {
        if (b2 = this._daylightSavingAdjust(new Date(U2, K2, t2.selectedDay)), y2 = " ui-corner-all", w2 = "", Y2) {
          if (w2 += "<div class='ui-datepicker-group", 1 < L2[1]) switch (v2) {
            case 0:
        ...
        for (w2 += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + y2 + "'>" + (/all|left/.test(y2) && 0 === m2 ? N2 ? s2 : i2 : "") + (/all|right/.test(y2) && 0 === m2 ? N2 ? i2 : s2 : "") + this._generateMonthYearHeader(t2, K2, U2, j2, q2, 0 < m2 || 0 < v2, l2, h2) + "</div><table class='ui-datepicker-calendar'><thead><tr>", x2 = o2 ? "<th class='ui-datepicker-week-col'>" + this._get(t2, "weekHeader") + "</th>" : "", g2 = 0; g2 < 7; g2++) x2 += "<th scope='col'" + (5 <= (g2 + n2 + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + a2[k2 = (g2 + n2) % 7] + "'>" + r2[k2] + "</span></th>";
  ...
  }, V.datepicker = new b(), V.datepicker.initialized = false, V.datepicker.uuid = (/* @__PURE__ */ new Date()).getTime(), V.datepicker.version = "1.13.0";
  V.datepicker;
  V.widget("ui.dialog", { version: "1.13.0", options: { appendTo: "body", autoOpen: true, buttons: [], classes: { "ui-dialog": "ui-corner-all", "ui-dialog-titlebar": "ui-corner-all" }, closeOnEscape: true, closeText: "Close", draggable: true, hide: null, height: "auto", maxHeight: null, maxWidth: null, minHeight: 150, minWidth: 150, modal: false, position: { my: "center", at: "center", of: window, collision: "fit", using: function(t2) {
    ...
    this.uiDialog = V("<div>").hide().attr({ tabIndex: -1, role: "dialog" }).appendTo(this._appendTo()), this._addClass(this.uiDialog, "ui-dialog", "ui-widget ui-widget-content ui-front"), this._on(this.uiDialog, { keydown: function(t2) {
      if (this.options.closeOnEscape && !t2.isDefaultPrevented() && t2.keyCode && t2.keyCode === V.ui.keyCode.ESCAPE) return t2.preventDefault(), void this.close(t2);
      var e2, i2, s2;
  ...
  V.ui.dialog, V.widget("ui.progressbar", { version: "1.13.0", options: { classes: { "ui-progressbar": "ui-corner-all", "ui-progressbar-value": "ui-corner-left", "ui-progressbar-complete": "ui-corner-right" }, max: 100, value: 0, change: null, complete: null }, min: 0, _create: function() {
  ...
  } }), V.widget("ui.selectmenu", [V.ui.formResetMixin, { version: "1.13.0", defaultElement: "<select>", options: { appendTo: null, classes: { "ui-selectmenu-button-open": "ui-corner-top", "ui-selectmenu-button-closed": "ui-corner-all" }, disabled: null, icons: { button: "ui-icon-triangle-1-s" }, position: { my: "left top", at: "left bottom", collision: "none" }, width: false, change: null, close: null, focus: null, open: null, select: null }, _create: function() {
    ...
    var t2;
    this.range && (window.getSelection ? ((t2 = window.getSelection()).removeAllRanges(), t2.addRange(this.range)) : this.range.select(), this.button.focus());
  ...
  } }]), V.widget("ui.slider", V.ui.mouse, { version: "1.13.0", widgetEventPrefix: "slide", options: { animate: false, classes: { "ui-slider": "ui-corner-all", "ui-slider-handle": "ui-corner-all", "ui-slider-range": "ui-corner-all ui-widget-header" }, distance: 0, max: 100, min: 0, orientation: "horizontal", range: false, step: 1, value: 0, values: null, change: null, slide: null, start: null, stop: null }, numPages: 5, _create: function() {
    ...
    var i2, s2, n2;
    if (1 < arguments.length) return this.options.values[t2] = this._trimAlignValue(e2), this._refreshValue(), void this._change(null, t2);
    ...
    var e2, i2;
    if (arguments.length) return t2 = this.options.values[t2], t2 = this._trimAlignValue(t2);
    ...
    if (t2 <= this._valueMin()) return this._valueMin();
    ...
    switch (t2.keyCode) {
      ...
      case V.ui.keyCode.DOWN:
      case V.ui.keyCode.LEFT:
        if (t2.preventDefault(), !this._keySliding && (this._keySliding = true, this._addClass(V(t2.target), null, "ui-state-active"), false === this._start(t2, n2))) return;
    }
  ...
  V.widget("ui.spinner", { version: "1.13.0", defaultElement: "<input>", widgetEventPrefix: "spin", options: { classes: { "ui-spinner": "ui-corner-all", "ui-spinner-down": "ui-corner-br", "ui-spinner-up": "ui-corner-tr" }, culture: null, icons: { down: "ui-icon-triangle-1-s", up: "ui-icon-triangle-1-n" }, incremental: true, max: null, min: null, numberFormat: null, page: 10, step: 1, change: null, spin: null, start: null, stop: null }, _create: function() {
    ...
    var i2;
    if ("culture" === t2 || "numberFormat" === t2) return i2 = this._parse(this.element.val()), this.options[t2] = e2, void this.element.val(this._format(i2));
  ...
  var S;
  V.ui.spinner;
  V.widget("ui.tabs", { version: "1.13.0", delay: 300, options: { active: null, classes: { "ui-tabs": "ui-corner-all", "ui-tabs-nav": "ui-corner-all", "ui-tabs-panel": "ui-corner-bottom", "ui-tabs-tab": "ui-corner-top" }, collapsible: false, event: "click", heightStyle: "content", hide: null, show: null, activate: null, beforeActivate: null, beforeLoad: null, load: null }, _isLocal: (S = /#.*$/, function(t2) {
    var e2 = t2.href.replace(S, ""), i2 = location.href.replace(S, "");
    try {
  ...
  V.ui.tabs;
  V.widget("ui.tooltip", { version: "1.13.0", options: { classes: { "ui-tooltip": "ui-corner-all ui-widget-shadow" }, content: function() {
    ...
    e2[0] !== this.element[0] && (i2.remove = function() {
      this._removeTooltip(this._find(e2).tooltip);
  ...
  V.ui.tooltip;
  var H = V, z = {}, A = z.toString, O = /^([\-+])=\s*(\d+\.?\d*)/, N = [{ re: /rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/, parse: function(t2) {
  ...
  } }], E = H.Color = function(t2, e2, i2, s2) {
    return new H.Color.fn.parse(t2, e2, i2, s2);
  }, W = { rgba: { props: { red: { idx: 0, type: "byte" }, green: { idx: 1, type: "byte" }, blue: { idx: 2, type: "byte" } } }, hsla: { props: { hue: { idx: 0, type: "degrees" }, saturation: { idx: 1, type: "percent" }, lightness: { idx: 2, type: "percent" } } } }, F = { byte: { floor: true, max: 255 }, percent: { max: 1 }, degrees: { mod: 360, floor: true } }, L = E.support = {}, R = H("<p>")[0], Y = H.each;
  function B(t2) {
    return null == t2 ? t2 + "" : "object" == typeof t2 ? z[A.call(t2)] || "object" : typeof t2;
  }
  function j(t2, e2, i2) {
    var s2 = F[e2.type] || {};
  ...
  function q(s2) {
    var n2 = E(), o2 = n2._rgba = [];
    return s2 = s2.toLowerCase(), Y(N, function(t2, e2) {
      var i2 = e2.re.exec(s2), i2 = i2 && e2.parse(i2), e2 = e2.space || "rgba";
      if (i2) return i2 = n2[e2](i2), n2[W[e2].cache] = i2[W[e2].cache], o2 = n2._rgba = i2._rgba, false;
    }), o2.length ? ("0,0,0,0" === o2.join() && H.extend(o2, st.transparent), n2) : st[s2];
  }
  function K(t2, e2, i2) {
    return 6 * (i2 = (i2 + 1) % 1) < 1 ? t2 + (e2 - t2) * i2 * 6 : 2 * i2 < 1 ? e2 : 3 * i2 < 2 ? t2 + (e2 - t2) * (2 / 3 - i2) * 6 : t2;
  }
  R.style.cssText = "background-color:rgba(1,1,1,.5)", L.rgba = -1 < R.style.backgroundColor.indexOf("rgba"), Y(W, function(t2, e2) {
    e2.cache = "_" + t2, e2.props.alpha = { idx: 3, type: "percent", def: 1 };
  }), H.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function(t2, e2) {
    z["[object " + e2 + "]"] = e2.toLowerCase();
  }), (E.fn = H.extend(E.prototype, { parse: function(n2, t2, e2, i2) {
    if (void 0 === n2) return this._rgba = [null, null, null, null], this;
    (n2.jquery || n2.nodeType) && (n2 = H(n2).css(t2), t2 = void 0);
    var o2 = this, s2 = B(n2), a2 = this._rgba = [];
    return void 0 !== t2 && (n2 = [n2, t2, e2, i2], s2 = "array"), "string" === s2 ? this.parse(q(n2) || st._default) : "array" === s2 ? (Y(W.rgba.props, function(t3, e3) {
      a2[e3.idx] = j(n2[e3.idx], e3);
    }), this) : "object" === s2 ? (Y(W, n2 instanceof E ? function(t3, e3) {
      n2[e3.cache] && (o2[e3.cache] = n2[e3.cache].slice());
    } : function(t3, i3) {
      var s3 = i3.cache;
      Y(i3.props, function(t4, e3) {
        if (!o2[s3] && i3.to) {
          if ("alpha" === t4 || null == n2[t4]) return;
          o2[s3] = i3.to(o2._rgba);
        }
        o2[s3][e3.idx] = j(n2[t4], e3, true);
      }), o2[s3] && H.inArray(null, o2[s3].slice(0, 3)) < 0 && (null == o2[s3][3] && (o2[s3][3] = 1), i3.from && (o2._rgba = i3.from(o2[s3])));
    }), this) : void 0;
  }, is: function(t2) {
    var n2 = E(t2), o2 = true, a2 = this;
    return Y(W, function(t3, e2) {
      var i2, s2 = n2[e2.cache];
      return s2 && (i2 = a2[e2.cache] || e2.to && e2.to(a2._rgba) || [], Y(e2.props, function(t4, e3) {
        if (null != s2[e3.idx]) return o2 = s2[e3.idx] === i2[e3.idx];
      })), o2;
    }), o2;
  }, _space: function() {
    var i2 = [], s2 = this;
    return Y(W, function(t2, e2) {
      s2[e2.cache] && i2.push(t2);
    }), i2.pop();
  }, transition: function(t2, a2) {
    var e2 = (h2 = E(t2))._space(), i2 = W[e2], t2 = 0 === this.alpha() ? E("transparent") : this, r2 = t2[i2.cache] || i2.to(t2._rgba), l2 = r2.slice(), h2 = h2[i2.cache];
    return Y(i2.props, function(t3, e3) {
      var i3 = e3.idx, s2 = r2[i3], n2 = h2[i3], o2 = F[e3.type] || {};
      null !== n2 && (null === s2 ? l2[i3] = n2 : (o2.mod && (n2 - s2 > o2.mod / 2 ? s2 += o2.mod : s2 - n2 > o2.mod / 2 && (s2 -= o2.mod)), l2[i3] = j((n2 - s2) * a2 + s2, e3)));
    }), this[e2](l2);
  }, blend: function(t2) {
    if (1 === this._rgba[3]) return this;
    var e2 = this._rgba.slice(), i2 = e2.pop(), s2 = E(t2)._rgba;
    return E(H.map(e2, function(t3, e3) {
      return (1 - i2) * s2[e3] + i2 * t3;
    }));
  }, toRgbaString: function() {
    var t2 = "rgba(", e2 = H.map(this._rgba, function(t3, e3) {
      return null != t3 ? t3 : 2 < e3 ? 1 : 0;
    });
    return 1 === e2[3] && (e2.pop(), t2 = "rgb("), t2 + e2.join() + ")";
  }, toHslaString: function() {
    var t2 = "hsla(", e2 = H.map(this.hsla(), function(t3, e3) {
    ...
    return t2 && e2.push(~~(255 * i2)), "#" + H.map(e2, function(t3) {
      return 1 === (t3 = (t3 || 0).toString(16)).length ? "0" + t3 : t3;
    }).join("");
  }, toString: function() {
    return 0 === this._rgba[3] ? "transparent" : this.toRgbaString();
  } })).parse.prototype = E.fn, W.hsla.to = function(t2) {
    if (null == t2[0] || null == t2[1] || null == t2[2]) return [null, null, null, t2[3]];
  ...
  }, W.hsla.from = function(t2) {
    if (null == t2[0] || null == t2[1] || null == t2[2]) return [null, null, null, t2[3]];
    var e2 = t2[0] / 360, i2 = t2[1], s2 = t2[2], t2 = t2[3], i2 = s2 <= 0.5 ? s2 * (1 + i2) : s2 + i2 - s2 * i2, s2 = 2 * s2 - i2;
    return [Math.round(255 * K(s2, i2, e2 + 1 / 3)), Math.round(255 * K(s2, i2, e2)), Math.round(255 * K(s2, i2, e2 - 1 / 3)), t2];
  }, Y(W, function(l2, t2) {
    var e2 = t2.props, o2 = t2.cache, a2 = t2.to, r2 = t2.from;
    E.fn[l2] = function(t3) {
      if (a2 && !this[o2] && (this[o2] = a2(this._rgba)), void 0 === t3) return this[o2].slice();
      var i2 = B(t3), s2 = "array" === i2 || "object" === i2 ? t3 : arguments, n2 = this[o2].slice();
      return Y(e2, function(t4, e3) {
        t4 = s2["object" === i2 ? t4 : e3.idx];
        null == t4 && (t4 = n2[e3.idx]), n2[e3.idx] = j(t4, e3);
      }), r2 ? ((t3 = E(r2(n2)))[o2] = n2, t3) : E(n2);
    }, Y(e2, function(a3, r3) {
      E.fn[a3] || (E.fn[a3] = function(t3) {
        var e3, i2 = B(t3), s2 = "alpha" === a3 ? this._hsla ? "hsla" : "rgba" : l2, n2 = this[s2](), o3 = n2[r3.idx];
        return "undefined" === i2 ? o3 : ("function" === i2 && (i2 = B(t3 = t3.call(this, o3))), null == t3 && r3.empty ? this : ("string" === i2 && (e3 = O.exec(t3)) && (t3 = o3 + parseFloat(e3[2]) * ("+" === e3[1] ? 1 : -1)), n2[r3.idx] = t3, this[s2](n2)));
      });
    });
  }), (E.hook = function(t2) {
    t2 = t2.split(" ");
    Y(t2, function(t3, o2) {
      H.cssHooks[o2] = { set: function(t4, e2) {
        var i2, s2, n2 = "";
        if ("transparent" !== e2 && ("string" !== B(e2) || (i2 = q(e2)))) {
          if (e2 = E(i2 || e2), !L.rgba && 1 !== e2._rgba[3]) {
            for (s2 = "backgroundColor" === o2 ? t4.parentNode : t4; ("" === n2 || "transparent" === n2) && s2 && s2.style; ) try {
              n2 = H.css(s2, "backgroundColor"), s2 = s2.parentNode;
            } catch (t5) {
            }
      ...
      } }, H.fx.step[o2] = function(t4) {
        t4.colorInit || (t4.start = E(t4.elem, o2), t4.end = E(t4.end), t4.colorInit = true), H.cssHooks[o2].set(t4.elem, t4.start.transition(t4.end, t4.pos));
      };
    });
  })("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor"), H.cssHooks.borderColor = { expand: function(i2) {
    var s2 = {};
    return Y(["Top", "Right", "Bottom", "Left"], function(t2, e2) {
      s2["border" + e2 + "Color"] = i2;
    }), s2;
  } };
  var U, X, $, G, Q, J, Z, tt, et, it, st = H.Color.names = { aqua: "#00ffff", black: "#000000", blue: "#0000ff", fuchsia: "#ff00ff", gray: "#808080", green: "#008000", lime: "#00ff00", maroon: "#800000", navy: "#000080", olive: "#808000", purple: "#800080", red: "#ff0000", silver: "#c0c0c0", teal: "#008080", white: "#ffffff", yellow: "#ffff00", transparent: [null, null, null, 0], _default: "#ffffff" }, nt = "ui-effects-", ot = "ui-effects-style", at = "ui-effects-animated";
  function rt(t2) {
  ...
  V.effects = { effect: {} }, G = ["add", "remove", "toggle"], Q = { border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1 }, V.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(t2, e2) {
    V.fx.step[e2] = function(t3) {
      ("none" !== t3.end && !t3.setAttr || 1 === t3.pos && !t3.setAttr) && (H.style(t3.elem, e2, t3.end), t3.setAttr = true);
    };
    ...
    return this.queue(function() {
      var i3 = V(this), t3 = i3.attr("class") || "", e3 = (e3 = o2.children ? i3.find("*").addBack() : i3).map(function() {
        ...
        V.each(G, function(t4, e4) {
          n2[e4] && i3[e4 + "Class"](n2[e4]);
        });
      };
      s2(), e3 = e3.map(function() {
        return this.end = rt(this.el[0]), this.diff = (function(t4, e4) {
          var i4, s3, n3 = {};
          for (i4 in e4) s3 = e4[i4], t4[i4] !== s3 && (Q[i4] || !V.fx.step[i4] && isNaN(parseFloat(s3)) || (n3[i4] = s3));
          return n3;
  ...
  }, V.fn.extend({ addClass: ($ = V.fn.addClass, function(t2, e2, i2, s2) {
    return e2 ? V.effects.animateClass.call(this, { add: t2 }, e2, i2, s2) : $.apply(this, arguments);
  }), removeClass: (X = V.fn.removeClass, function(t2, e2, i2, s2) {
    return 1 < arguments.length ? V.effects.animateClass.call(this, { remove: t2 }, e2, i2, s2) : X.apply(this, arguments);
  }), toggleClass: (U = V.fn.toggleClass, function(t2, e2, i2, s2, n2) {
    return "boolean" == typeof e2 || void 0 === e2 ? i2 ? V.effects.animateClass.call(this, e2 ? { add: t2 } : { remove: t2 }, i2, s2, n2) : U.apply(this, arguments) : V.effects.animateClass.call(this, { toggle: t2 }, e2, i2, s2);
  }), switchClass: function(t2, e2, i2, s2, n2) {
    return V.effects.animateClass.call(this, { add: e2, remove: t2 }, i2, s2, n2);
  } }), V.expr && V.expr.pseudos && V.expr.pseudos.animated && (V.expr.pseudos.animated = (J = V.expr.pseudos.animated, function(t2) {
    return !!V(t2).data(at) || J(t2);
  })), false !== V.uiBackCompat && V.extend(V.effects, { save: function(t2, e2) {
    for (var i2 = 0, s2 = e2.length; i2 < s2; i2++) null !== e2[i2] && t2.data(nt + e2[i2], t2[0].style[e2[i2]]);
  }, restore: function(t2, e2) {
    for (var i2, s2 = 0, n2 = e2.length; s2 < n2; s2++) null !== e2[s2] && (i2 = t2.data(nt + e2[s2]), t2.css(e2[s2], i2));
  ...
  } }), V.extend(V.effects, { version: "1.13.0", define: function(t2, e2, i2) {
    return i2 || (i2 = e2, e2 = "effect"), V.effects.effect[t2] = i2, V.effects.effect[t2].mode = e2, i2;
  }, scaledDimensions: function(t2, e2, i2) {
    if (0 === e2) return { height: 0, width: 0, outerHeight: 0, outerWidth: 0 };
    ...
    t2.data(ot, t2[0].style.cssText);
  }, restoreStyle: function(t2) {
    t2[0].style.cssText = t2.data(ot) || "", t2.removeData(ot);
  }, mode: function(t2, e2) {
    t2 = t2.is(":hidden");
    ...
    function t2(t3) {
      ...
      e3.data(at, true), l2.push(i3), o2 && ("show" === i3 || i3 === o2 && "hide" === i3) && e3.show(), o2 && "none" === i3 || V.effects.saveStyle(e3), "function" == typeof t3 && t3();
    }
    var s2 = lt.apply(this, arguments), n2 = V.effects.effect[s2.effect], o2 = n2.mode, e2 = s2.queue, i2 = e2 || "fx", a2 = s2.complete, r2 = s2.mode, l2 = [];
    ...
    function h2(t3) {
      ...
      s2.mode = l2.shift(), false === V.uiBackCompat || o2 ? "none" === s2.mode ? (e3[r2](), i3()) : n2.call(e3[0], s2, function() {
        e3.removeData(at), V.effects.cleanUp(e3), "hide" === s2.mode && e3.hide(), i3();
      }) : (e3.is(":hidden") ? "hide" === r2 : "show" === r2) ? (e3[r2](), i3()) : n2.call(e3[0], s2, i3);
    }
  }, show: (et = V.fn.show, function(t2) {
    if (ht(t2)) return et.apply(this, arguments);
    t2 = lt.apply(this, arguments);
    return t2.mode = "show", this.effect.call(this, t2);
  }), hide: (tt = V.fn.hide, function(t2) {
    if (ht(t2)) return tt.apply(this, arguments);
    t2 = lt.apply(this, arguments);
    return t2.mode = "hide", this.effect.call(this, t2);
  }), toggle: (Z = V.fn.toggle, function(t2) {
    if (ht(t2) || "boolean" == typeof t2) return Z.apply(this, arguments);
    t2 = lt.apply(this, arguments);
  ...
  }, it = {}, V.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(e2, t2) {
    it[t2] = function(t3) {
      return Math.pow(t3, e2 + 2);
    };
  }), V.extend(it, { Sine: function(t2) {
  ...
  R = V.effects, V.effects.define("blind", "hide", function(t2, e2) {
    ...
    for (V.effects.createPlaceholder(n2), l2 = n2.css(p2), h2 = h2 || n2["top" == p2 ? "outerHeight" : "outerWidth"]() / 3, r2 && ((s2 = { opacity: 1 })[p2] = l2, n2.css("opacity", 0).css(p2, f2 ? 2 * -h2 : 2 * h2).animate(s2, u2, d2)), a2 && (h2 /= Math.pow(2, c2 - 1)), (s2 = {})[p2] = l2; g2 < c2; g2++) (i2 = {})[p2] = (f2 ? "-=" : "+=") + h2, n2.animate(i2, u2, d2).animate(s2, u2, d2), h2 = a2 ? 2 * h2 : h2 / 2;
    ...
    for (V.effects.createPlaceholder(s2), u2[h2] = (c2 ? "-=" : "+=") + o2, d2[h2] = (c2 ? "+=" : "-=") + 2 * o2, p2[h2] = (c2 ? "-=" : "+=") + 2 * o2, s2.animate(u2, l2, t2.easing); i2 < a2; i2++) s2.animate(d2, l2, t2.easing).animate(p2, l2, t2.easing);
